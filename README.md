# PocketBase at KhulnaSoft 0.25.8
> [KhulnaSoft](https://github.com/khulnasoft/khulnasoft) x [Pocketbase](https://pocketbase.io/) releases to AMD & ARM architectures.
...
1. Propose an update in [Issues](https://github.com/khulnasoft/pocketbase/issues).
